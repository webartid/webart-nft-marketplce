...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetween mt-10">
      <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base">Total</p>
      <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm minlg:text-xl">{nft.price} <span className="font-semibold">{nftCurrency}</span></p>
    </div>
  </div>
);
...
const NFTDetails = () => {
  ...
  const [nft, setNft] = useState({ image: '', tokenId: '', owner: '', price: '', seller: '' });
  ...
  return (
    <div className="relative flex justify-center md:flex-col mih-h-screen">
